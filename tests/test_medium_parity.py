...
medium keeps late.max ≤ allowed_lateness, so there are no state-misses and
recall is a clean 1.0; precision < 1 is organic last-touch over-credit only (no
wrong-household — that is a Phase-8 fault story, not medium).
