...
Contract for the `phase-14-scaling-curve` branch. Source: post-plan extension —
...
SCALING.md asserts ~200 B/exposure and extrapolates to "~3 TB at 25k/sec × 7 d." A
fully-sized scaling story — every number an order-of-magnitude guess — is the weak
spot in that claim. You don't need 500k/sec — you need **one measured
