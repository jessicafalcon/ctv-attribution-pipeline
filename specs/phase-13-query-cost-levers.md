...
Contract for the `phase-13-query-cost-levers` branch. Source: JD-alignment
follow-on — **not** in the original `docs/PHASES.md` plan (Phases 0–11). Covers
sketch 3 (a real "made this query measurably cheaper, and why" story).
...
pre-aggregation (rollup vs full scan). The posting asks for a **specific, explainable
story about a query you made measurably faster, and why it worked.** The compelling
