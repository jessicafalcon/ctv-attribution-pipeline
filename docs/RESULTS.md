...
check-docs` (the scale-curve block lives in `docs/SCALING.md`, same guard). Dated
captures, not guarded: the benchmark, agent-eval and lakehouse tables — each says when
it was measured.
